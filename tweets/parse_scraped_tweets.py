...
def tweet_jsons_to_csv(tweets_dir: str | os.PathLike, output_file: str | os.PathLike, media_output_json: str | os.PathLike = None):
...

    {
        ...
        "otherPropertiesMap": {
            ...
            "tweet_text": "The MBTA Board of Directors Subcommittees will hold virtual or in-person meetings as follows:\nOn Thursday, November 2:\n• 9 AM - Audit &amp; Finance\n• 10 AM - Planning, Workforce, Development &amp; Compensation\n• 11 AM - Safety, Health &amp; Environment\n\nDetails: https://t.co/5LyrlfhayS https://t.co/QDYBNJbYUm",
            "owner_screen_name": "MBTA",
